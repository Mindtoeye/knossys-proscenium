 ...
 *
 */
export class DesktopPanel extends React.Component {
  ...
  */
  ...
  render() {
    ...
    return (
    <div id={this.props.id} className="desktopPanel" style={{left: xPos, top: yPos, width: aWidth, height: aHeight,zIndex: anIndex}}>
      {titleElement}
      <div className="desktopPanelContent">
        {this.props.children}
      </div>
      {labelElement}    
    </div>
